...
(function webpackUniversalModuleDefinition(root, factory) {
    if(typeof exports === 'object' && typeof module === 'object')
        ...
        define("commons/math/math-debug",factory);
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            exports.deepEqual = function deepEqual (a, b) {
                ...
                if (_.isArray(a)) {
                    ...
                    if (_.isArray(b) || !(b instanceof Object)) {
                        return false;
                    }
	   ...
	   *    });
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            ;(function (global) {
                 ...
                 *   n is any number, including 锟絀nfinity unless stated.
                 *
                 *   pow( x, NaN )                           = NaN
                 *   pow( x, 锟�0 )                            = 1
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            function DimensionError(actual, expected, relation) {
                ...
                this.message = 'Dimension mismatch (' +
                    (_.isArray(actual) ? ('[' + actual.join(', ') + ']') : actual) +
                    ' ' + (this.relation || '!=') + ' ' +
                    (_.isArray(expected) ? ('[' + expected.join(', ') + ']') : expected) +
                    ')';
	 ...
	 *     });
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            exports.addBraces = function(s, brace, type) {
                ...
                else if (_.isArray(brace) && brace.length === 2) {
                    braces = brace;
                }
                else {
                    braces = [brace, brace];
