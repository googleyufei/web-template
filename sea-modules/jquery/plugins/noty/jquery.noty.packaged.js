 ...
 *
 **/
define("jquery/plugins/noty/jquery.noty.packaged", ['jquery'], function (require, exports, module) {
    ...
    (function ($) {
        ...
        var NotyObject = {
            ...
            show: function () {
                ...
                self.$qycCloseBtn.one('click', function (evt) {
                    self.stopPropagation(evt);
                    self.close();
                });
...
// Helpers
    ...
    noty.success = function (text) {
        return noty({
            text: text,
            template: '<div class="noty_message"><i class="icon-custom-noty-success"></i>' +
    ...
    noty.error = function (text, callback) {
        return noty({
            text: text,
            type: 'alert',
            'modal': true,
            ...
            'buttons': [
                {addClass: 'btn noty-btn-error', text: msgs.msg141, onClick: function ($noty) {
                    $noty.close();
                    callback && callback();
                }
                }
    ...
    noty.warn = function (text, callback) {
        return noty({
            text: text,
            type: 'warning',
            'modal': true,
            ...
            buttons: [
                {addClass: 'btn noty-btn-retry', text: msgs.msg199, onClick: function ($noty) {
                    $noty.close();
                    callback && callback(true);
                }
                },
                {addClass: 'btn noty-btn-cancel', text: msgs.msg87, onClick: function ($noty) {
                    $noty.close();
     ...
     * @returns {*}
     */
    noty.confirm = function (text, callback) {
        var _noty = noty({
            text: text,
            'type': 'confirm',
            'modal': true,
            ...
            buttons: [
                {addClass: 'btn noty-btn-confirm', text: msgs.msg168, onClick: function ($noty) {
                    // this = button element
                    // $noty = $noty element
                    $noty.close();
                    callback && callback(true);
     ...
     * @returns {*}
     */
    noty.alert = function (text, callback) {
        return noty({
            text: text,
            'type': 'alert',
            ...
            'modal': true,
            'buttons': [
                {addClass: 'btn noty-btn-alert', text: msgs.msg141, onClick: function ($noty) {
                    // this = button element
                    // $noty = $noty element
                    $noty.close();
                    callback && callback();
